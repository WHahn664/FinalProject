...
# Save results as SVG tables
save_table(results_untuned_raw, 'results/untuned_raw.svg')
save_table(results_untuned_log, 'results/untuned_log.svg')
save_table(results_tuned_raw, 'results/tuned_raw.svg')
save_table(results_tuned_log, 'results/tuned_log.svg')
